...
import { Clock, Lock, ThumbsUp, Send, Calendar, User, Moon, Sun, Search, TrendingUp, Mail, BarChart3, Loader, Sparkles, Heart, Star, Smile, X, CheckCircle, AlertCircle, ChevronDown, ChevronUp } from 'lucide-react';
...
function App() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      if (todayIndex === -1) {
        // Bugün yoksa en son 30 mesajı göster
        ...
        // Bugünden başla, sonrasını göster (geleceğe doğru)
  ...
  const todayDate = new Date().toISOString().split('T')[0];const stats = {
